...
if __name__ == "__main__":
    # Taking user input for board size and initial position
    N = int(input("Enter the size of the board (N x N): "))
    x = int(input(f"Enter the row number of the 1st queen (0 to {N-1}): "))
    y = int(input(f"Enter the column number of the 1st queen (0 to {N-1}): "))
